...
export const MODULES: readonly ModuleDefinition[] = [
  ...
  { key: 'work_reports', labelDe: 'Arbeitsberichte', domain: 'tasks', core: false, menuPath: '/work-reports', description: 'PDF-Arbeitsberichte mit Unterschrift.' },
  ...
  { key: 'photos', labelDe: 'Fotos', domain: 'resources', core: false, menuPath: '/photos', description: 'Vorher/Nachher-Dokumentation.' },
  ...
  { key: 'shifts', labelDe: 'Schichten', domain: 'field', core: false, menuPath: '/shifts', description: 'Schichtmodelle für die Einsatzplanung.' },
