...
/**
 * Client-Komponente fuer die Recovery-Codes-Sektion im Konto-Bereich
 * (Sprint 26). Zeigt an, wie viele der 10 Recovery-Codes noch unverbraucht
 * sind, und bietet einen "Generieren"-Button. Nach erfolgreicher Generierung
 * werden die frischen Klartext-Codes EIN MAL angezeigt (der Server gibt sie
 * nur in dieser einen Response zurueck) und koennen als Textdatei
 * heruntergeladen werden.
 */
export function RecoveryCodesForm({ unusedCount }: { unusedCount: number }) {
  ...
  function handleDownload() {
    ...
    const header = [
      ...
      'ohne Ihr Authenticator-Geraet ist Ihr Konto nicht mehr wiederher-',
      'stellbar.',
      '',
      '---',
      '',
    ...
    a.href = url;
    a.download = `hausmeister-app-recovery-codes-${stamp}.txt`;
