...
import {
  enrollPortalMfaFactorAction,
  unenrollPortalMfaFactorAction,
  verifyPortalMfaEnrollmentAction,
  type PortalAccountActionState,
  type PortalMfaEnrollState,
} from './actions';
...
const INITIAL_ENROLL: PortalMfaEnrollState = {};
const INITIAL_VERIFY: PortalAccountActionState = {};
const INITIAL_UNENROLL: PortalAccountActionState = {};

/**
 * Sprint 32: Portal-Variante des Staff-MfaForm. Identische UX (QR-Code +
 * 6-stelliger Code), aber gegen die Portal-Server-Actions gedraht.
 * Absichtlich dupliziert statt geteilt, damit spaetere Portal-Anpassungen
 * (kein Recovery-Hinweis, andere Warntexte, …) den Staff-Flow nicht
 * versehentlich mit brechen.
 */
export function PortalMfaForm({ factors }: { factors: Factor[] }) {
